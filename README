...
2- Import the Project as Eclipse Project (Environment details listed below)
	- eclipse Version: Oxygen.2 Release (4.7.2) Build id: 20171218-0600 
	- Java version 1.8.0_144
3- Run the JDeodorantMetricsExtension as an Eclipse Application
4- Import the SampleTest as a Java Project on the new eclipse window which will open once you execute step 3
5- Click on the Test Project and use the Metrics Menu to calcualte the Metrics
